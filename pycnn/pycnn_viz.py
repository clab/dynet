...
def pick(a, index=0): return GVExpr('pick', [a, index], copy_dim(a))
def pick_batch(a, indices): return GVExpr('pick_batch', [a, indices], copy_dim(a))
...
def pickneglogsoftmax(x, v): return GVExpr('pickneglogsoftmax', [x,v], copy_dim(x))
def pickneglogsoftmax_batch(x, vs): return GVExpr('pickneglogsoftmax_batch', [x,vs], make_dim(len(vs)))
